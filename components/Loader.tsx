...
const Loader: React.FC = () => {
  return (
    <svg width="48" height="48" viewBox="0 0 58 58" xmlns="http://www.w3.org/2000/svg" className="inline-block">
      <g fill="none" fillRule="evenodd">
        <g transform="translate(2 1)" stroke="currentColor" strokeWidth="2" className="text-cyan-400">
